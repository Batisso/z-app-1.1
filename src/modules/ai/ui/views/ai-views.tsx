          ...
          <div className="relative flex flex-col rounded-xxl text-white transition-all duration-300 overflow-hidden lg:h-[100vh] md:h-[100vh]">
            ...
            <div className="hidden md:hidden lg:block absolute top-1/3 right-10 w-28 h-28 rounded-full bg-cover animate-float-2 z-10" style={{ backgroundImage: 'url("/backImage12.png")' }}></div>
                      ...
                      <div className="w-12 h-10 bg-gradient-to-br from-orange-400 to-red-600 rounded-xl flex items-center justify-center shadow-md">
                        <AtomIcon className="text-white font-bold text-lg" />
                          ...
                          <div>
                            ...
                            <p className="text-xs opacity-70 text-gray-800 ">Your Creative AI companions for an Authetic & Culture-First Creativity</p>
                          </div>
                        </div>
              ...
              <div className="flex flex-col items-center justify-center flex-1 text-center h-full mt-4 py-7 md:py-2 lg:py-7 px-4 md:px-5 bg-white/20 backdrop-blur-lg border border-white/30 rounded-2xl mx-7">
                ...
                <h1 className="text-3xl md:text-3xl lg:text-4xl font-extrabold text-gray-700 drop-shadow-lg"><span className="drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">WHERE</span> <span className="bg-gradient-to-r from-orange-500 to-blue-500 text-transparent bg-clip-text drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">GLOBAL</span> <span className="drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">CREATIVITY MEETS</span> <span className="bg-gradient-to-r from-purple-700 to-pink-500 text-transparent bg-clip-text drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">AI</span> </h1>

                <p className="text-lg md:text-2xl lg:text-xl text-gray-500 dark:text-gray-400 drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">Personal AI companions crafted and trained to fuel your creativity, unlock cultural knowledge, and connect you deeper to the global authentic experience anytime you ask. Pick your AI companion below and start your conversation! <br /> <ArrowDown className="mx-auto mt-4 text-black text-4xl animate-bounce" /></p>
              ...
              <div className="flex flex-1 p-4 md:p-1 md:flex-row flex-col justify-center mt-4">
                ...
                <div className="flex justify-center p-4 md:p-5 mx-auto w-full">
                  <div className="grid grid-cols-1 md:grid-cols-3 md:gap-10 w-full">
                    ...
                    {/* Card 1 */}
                    <Link href="/ai/aurelium" className="rounded-4xl lg:w-100 lg:h-90 shadow-xl bg-white/30 backdrop-blur-lg border-2 border-white/40 hover:ring-2 ring-amber-500 transition-all duration-800 hover:scale-105 w-full md:w-60 md:h-100 flex-shrink-0">
                      ...
                      <div className="p-4">
                        <h3 className="text-xl font-semibold text-center text-black">AURELIUM</h3>
                    ...
                    {/* Card 2 */}
                    <Link href="/ai/liya" className="rounded-4xl lg:w-100 lg:h-90 shadow-xl bg-white/20 backdrop-blur-lg border border-white/30 hover:ring-2 ring-amber-500 transition-all duration-800 hover:scale-105 w-full md:w-60 md:h-100 flex-shrink-0">
                      <div className="relative">
                        <div className="relative w-50 h-50 mx-auto mt-4 rounded-xl overflow-hidden">
                          <img
                            src="/liya.png"
                      ...
                      <div className="p-4">
                        <h3 className="text-xl font-semibold text-black text-center">LIYA</h3>
                    ...
                    {/* Card 3 */}
                    <Link href="/ai/satoshi" className="rounded-4xl lg:w-100 lg:h-90 shadow-xl bg-white/20 backdrop-blur-lg border border-white/30 hover:ring-2 ring-amber-500 transition-all duration-800 hover:scale-105 w-full md:w-60 md:h-100 flex-shrink-0">
                      <div className="relative">
                        <div className="relative w-50 h-50 mx-auto mt-4 rounded-xl overflow-hidden">
                          <img
                            src="/satoshi.png"
                      ...
                      <div className="p-4">
                        <h3 className="text-xl font-semibold text-gray-800 text-center">SATOSHI</h3>
